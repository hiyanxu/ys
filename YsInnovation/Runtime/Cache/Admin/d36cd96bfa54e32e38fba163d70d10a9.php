...
<html>
    <head>
        ...
        <!--获取详细信息的js文件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/User/js/getRoleDetialById.js"></script>
        <!--保存按钮的保存事件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/User/js/editRoleSave.js"></script>
    </head>
    <body>
        <input type="hidden" id="inputRoleId">
        <div id="divTeaName">
            <label>角色名称：</label>
