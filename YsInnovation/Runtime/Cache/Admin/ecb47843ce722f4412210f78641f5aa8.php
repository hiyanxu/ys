...
<html>
    <head>
        ...
        <!--根据实验室的cookie信息得到实验室创新账号号段的js文件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/User/js/getInnoNumByCookieOrg.js"></script>
        <!--得到本条详细信息的js文件-->
        <script type="text/javascript" data="0" id="editUserScript" src="<?php echo (SURL); ?>Public/Admin/User/js/getTeaDetialById.js"></script>
        <!--保存按钮的事件-->
        <script type="text/javascript" data="0" id="userEditSaveScript" src="<?php echo (SURL); ?>Public/Admin/User/js/orgUserEditSave.js"></script>
    </head>
    <body>
        <div id="divTeaName">
            <label>学生姓名：</label>
        ...
        <div id="divTeaDuty">
            ...
            <label id="labelInnoNum" style="color: red; margin-left: 220px;"></label>
        </div>
        ...
        <div id="divTeaRole">
            <label>是否学生负责人：</label>
            <select id="selectIsCharge" class="input">
