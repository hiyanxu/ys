...
<html>
    <head>
        ...
        <!--通过实验室session信息得到实验室教室-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/getTeaByOrgCookie.js"></script>
        <!--点击增加时间安排部分js-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/imgClickHourAdd.js"></script>
        <!--获取本条课程的详细信息js-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/getOrgCourseDetialById.js"></script>
        <!--修改保存按钮的js-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/courseEditSave.js"></script>
    </head>
    <body>
