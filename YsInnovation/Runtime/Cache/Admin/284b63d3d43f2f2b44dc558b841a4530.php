    ...
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="media media-y">
                <a href="#" target="_blank"><img src="<?php echo (SURL); ?>Public/Admin/Pintuer/images/logo4.png" class="radius" alt="后台管理系统" /></a>
            </div>
            <br /><br />
            <form action="<?php echo ($think["const"]["/YsInnoCenter/YsInnovation/index.php/Admin/Login/login.html"]); ?>" method="post">
            <div class="panel">
                ...
                <div class="panel-body" style="padding:30px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                            ...
                            <img src="<?php echo ($think["const"]["/YsInnoCenter/YsInnovation/index.php/Admin/Login/"]); ?>makeVerify" width="80" height="32" class="passcode" />
                        </div>
                    </div>
                </div>
