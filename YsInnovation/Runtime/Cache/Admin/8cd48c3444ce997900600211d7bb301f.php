        ...
        <script type="text/javascript">
            $(function(){
                $("#inputAddUser").click(function(){
                    window.location.href="/YsInnoCenter/YsInnovation/index.php/Admin/User/showAddTea";
                });
            });
        </script>
        <!--教师页面分页显示js文件-->
        <script type="text/javascript" id="getUserListScript" data="1" src="<?php echo (SURL); ?>Public/Admin/User/js/getUserList.js"></script>
    </head>
    <body>
        <div id="divUserList">
            <div class="listHead">
