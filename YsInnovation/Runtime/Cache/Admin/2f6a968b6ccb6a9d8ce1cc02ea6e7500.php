...
<html>
    <head>
        ...
        <!--获取信息且显示的方法-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/getCourseDetialById.js"></script>
        <!--信息获取保存的js文件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/btnExamineSave.js"></script>
    </head>
    <body>
        ...
        <div id="divCourseExamine">
            <label>审核：</label>
            <select id="selectCourseExamine" class="input">
