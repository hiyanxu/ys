...
<html>
    <head>
        ...
        <!--保存按钮的事件-->
        <script type="text/javascript" data="0" id="userEditSaveScript" src="<?php echo (SURL); ?>Public/Admin/User/js/userEditSave.js"></script>
    </head>
    <body>
        <input id="inputUserId" type="hidden">
        <input id="inputUserAccountId" type="hidden">
        <div id="divTeaName">
            <label>学生姓名：</label>
