...
<html>
    <head>
        ...
        <!--得到详细信息的js文件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/getCourseDetial.js"></script>
    </head>
    <body>
        ...
        <div id="divCourseExamine">
            <label>当前状态：</label>
            <label style="position: absolute; margin-left: 80px; font-weight:bolder;">正在选课中</label>
        </div> 
        <div id="divCourseSelectNum">
            <label>当前选择人数：</label>
            <label id="labelCourseSelectNum" style="position: absolute; margin-left: 80px; font-weight:bolder;"></label>
        </div>
    </body>
</html>