...
<html>
    <head>
        ...
        <!--得到课程列表的js文件-->
        <script type="text/javascript" id="getCourseListScript" data="3&2" src="<?php echo (SURL); ?>Public/Admin/Course/js/getCourseList.js"></script>
        <!--修改按钮的事件-->
        <script type="text/javascript" src="<?php echo (SURL); ?>Public/Admin/Course/js/btnEdit.js"></script>
        <!--全选的按钮控制-->
            ...
            $(function(){
                ...
                $("#btnDelBatch").click(function(){                    
                    ...
                    {                        
                        $.ajax({
                            type:"POST",
                            url:"/YsInnoCenter/YsInnovation/index.php/Admin/Course/delBatchCourse",
                            data:{ids:ids},
                            dataType: "json",
                            success:function(result){
                                ...
                                window.location.href="/YsInnoCenter/YsInnovation/index.php/Admin/Course/ShowExaminedWorkShopList";*/
                            }
                        });                   
                    }
                    else
