...
<html>
    <head>
        ...
        <!--得到讲座列表的js文件-->
        <script type="text/javascript" id="getLectureListScript" data="2&3" src="<?php echo (SURL); ?>Public/Admin/Lecture/js/getLectureList.js"></script>
    </head>
    <body>
        <div id="divLectureList">
            ...
            <div class="listItemName">
                ...
                <div id="status" class="itemName" style="margin-left: 72%;">当前状态</div>
                <div id="operations" style=" margin-left: 80%;" class="itemName">操作</div>
            </div>
